...
var TextEditor = function (_React$Component) {
  ...
  function TextEditor(props) {
    ...
    _this.onChange = function (editorState) {
      console.log(editorState); // eslint-disable-line no-console
  ...
  _createClass(TextEditor, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { style: { border: '3px solid #eee', padding: 10 } },
        _react2.default.createElement(_draftJs.Editor, { editorState: this.state.editorState, onChange: this.onChange })
      );
    }
  }]);
