        ...
        <div className="row">
          <div className="col-md-8">
            ...
            <EventSummaryList
              ...
              teacher={teacher}
            />
            <h5 className="event-list-title" style={{background: "#8B698E", marginTop: 40}}><i className="far fa-check circle-icon--medium purple color-text"></i> <strong>Recent Events</strong></h5>
            <EventSummaryList
              index={1}
          ...
          <div className="col-md-4">
            <h5 className="event-list-title" style={{background: "#007DA0"}}><i className="far fa-cog circle-icon--medium pulse-blue"></i> <strong style={{color: 'white'}}>Quick Links</strong></h5>
            <div className="block-flat">
              <div className="content " style={{marginTop: 0}}>
                <h5 className="">
                  <div className="event-quick-link-icon">
                    <i className="far fa-calendar-check circle-icon--small green" style={{color: 'white!important', marginRight: 10}}></i>
                  </div>
                ...
                <h5 className="">
                  <div className="event-quick-link-icon">
                    <i className="far fa-calendar-alt circle-icon--small pulse-blue blue" style={{color: "white!important", marginRight: 10}}></i>
                  </div>
                  <strong className="event-quick-link-title">
                ...
                <h5>
                  <div className="event-quick-link-icon">
                    <i className="far fa-check circle-icon--small purple purple-text" style={{color: "white!important", marginRight: 10}}></i>
                  </div>
                  <strong className="event-quick-link-title">
                ...
                <h5 className="">
                  <div className="event-quick-link-icon">
                    <i className="far fa-hourglass  circle-icon--small orange action-required orange-text" style={{color: "white!important", marginRight: 10}}></i>
                  </div>
                  <strong className="event-quick-link-title">
