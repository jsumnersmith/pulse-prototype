    ...
    <nav className="directory-header__nav">
      ...
      <div className="btn-group" style={{marginLeft: 15}}>
        ...
        <ul className="dropdown-menu">
          ...
          <li><Link to={'/directory/groups/edit/0'}><i className="far fa-group circle-icon--small circle-icon--no-border" style={{marginRight: 5}}/> <strong>Add Group</strong></Link></li>
