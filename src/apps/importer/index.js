...
const FileNameDisplay = ({fileName, restart}) => (
  <div className="importer-file-name">
    <h5><i className="importer-file-name__icon far fa-file-code-o"/> You uploaded <strong className="underline--pulse-blue">{fileName}</strong> <span className="meta" onClick={restart} style={{float: 'right', cursor: 'pointer', fontSize: 11}}><i className="far fa-times"/> Cancel Changes</span></h5>
  </div>
)
