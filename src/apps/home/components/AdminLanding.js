    ...
    <div className="row">
      ...
      <div className="col-md-12">
        <LandingPageFeed
          items={[
            {
              title: <span>3 responses were submitted for <strong>Building Walkthrough</strong></span>,
              type: 'report',
              date: new Date(),
            },
            {
              title: <span>23 people atteneding <strong>Blended Learning Workshop</strong></span>,
              type: 'event',
              date: new Date(),
            },
            {
              title: <span>57 people atteneding <strong>PLC Workday</strong></span>,
              type: 'event',
              date: new Date(),
            },
            {
              title: <span>7 responses were submitted for <strong>Building Walkthrough</strong></span>,
              type: 'report',
              date: new Date(),
            }
          ]}
